...
<main class="flex flex-col items-center justify-center min-h-screen bg-gray-100">
    <div class="bg-white p-8 rounded rounded-lg border border-2 shadow-md w-full max-w-md -mt-20">
        ...
        <p class="mb-4 text-center">
            Masukan Username &amp; Password Kamu
        </p>
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-4">
                ...
                <x-text-input id="username_or_email" class="w-full px-3 py-2 border rounded" type="text" name="username_or_email" :value="old('username_or_email')" placeholder="Masukan Username atau Email" required autofocus autocomplete="username" />
