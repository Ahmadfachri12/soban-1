            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-4">
                            <label class="flex items-center">
                                <input class="mr-2" name="gender" type="radio" value="Laki-Laki" required />
                                Laki-Laki
                            </label>
                            <label class="flex items-center">
                                <input class="mr-2" name="gender" type="radio" value="Perempuan" required />
                                Perempuan
                            </label>
                        </div>
                    </div>
                    <div>
                        ...
                        <input class="w-full border border-gray-300 p-2 rounded" placeholder="Masukkan nomor telepon" type="tel" name="noTelepon" required />
                    </div>
                    <div>
